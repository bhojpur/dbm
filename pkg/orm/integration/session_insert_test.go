...
func TestInsertOneIfPkIsPoint(t *testing.T) {
	...
	type TestPoint struct {
		Id      *int64     `orm:"autoincr pk notnull 'id'"`
		Msg     *string    `orm:"varchar(255)"`
		Created *time.Time `orm:"created"`
	}
...
func TestInsertOneIfPkIsPointRename(t *testing.T) {
	...
	type TestPoint2 struct {
		Id      ID         `orm:"autoincr pk notnull 'id'"`
		Msg     *string    `orm:"varchar(255)"`
		Created *time.Time `orm:"created"`
	}
...
func TestInsertDefault2(t *testing.T) {
	...
	type DefaultInsert2 struct {
		...
		Name      string
		Url       string    `orm:"text"`
		CheckTime time.Time `orm:"not null default '2000-01-01 00:00:00'"`
	}
...
type CreatedInsert2 struct {
	Id      int64
	Created int64 `orm:"created"`
}
type CreatedInsert3 struct {
	Id      int64
	Created int `orm:"created bigint"`
}
type CreatedInsert4 struct {
	Id      int64
	Created int `orm:"created"`
}
type CreatedInsert5 struct {
	Id      int64
	Created time.Time `orm:"created bigint"`
}
...
func TestDefaultTime3(t *testing.T) {
	type PrepareTask struct {
		Id int `orm:"not null pk autoincr INT(11)" json:"id"`
		// ...
		StartTime JSONTime `orm:"not null default '2006-01-02 15:04:05' TIMESTAMP index" json:"start_time"`
		EndTime   JSONTime `orm:"not null default '2006-01-02 15:04:05' TIMESTAMP" json:"end_time"`
		Cuser     string   `orm:"not null default '' VARCHAR(64) index" json:"cuser"`
		Muser     string   `orm:"not null default '' VARCHAR(64)" json:"muser"`
		Ctime     JSONTime `orm:"not null default CURRENT_TIMESTAMP TIMESTAMP created" json:"ctime"`
		Mtime     JSONTime `orm:"not null default CURRENT_TIMESTAMP TIMESTAMP updated" json:"mtime"`
	}
	assert.NoError(t, PrepareEngine())
...
type MyJSONTime struct {
	Id      int64    `json:"id"`
	Created JSONTime `orm:"created" json:"created_at"`
}
...
func TestAnonymousStruct(t *testing.T) {
	type PlainObject struct {
		ID   uint64 `json:"id,string" orm:"'ID' pk autoincr"`
		Desc string `json:"desc" orm:"'DESC' notnull"`
	}
	type PlainFoo struct {
		PlainObject `orm:"extends"` // primary key defined in extends struct
		Width       uint32          `json:"width" orm:"'WIDTH' notnull"`
		Height      uint32          `json:"height" orm:"'HEIGHT' notnull"`
		Ext         struct {
			F1 uint32 `json:"f1,omitempty"`
			F2 uint32 `json:"f2,omitempty"`
		} `json:"ext" orm:"'EXT' json notnull"`
	}
	assert.NoError(t, PrepareEngine())
...
func TestInsertWhere(t *testing.T) {
	type InsertWhere struct {
		Id     int64
		Index  int   `orm:"unique(s) notnull"`
		RepoId int64 `orm:"unique(s)"`
		Width  uint32
		Height uint32
		Name   string
		IsTrue bool
...
type NightlyRate struct {
	ID int64 `orm:"'id' not null pk BIGINT(20)" json:"id"`
}
...
func TestInsertMultiWithOmit(t *testing.T) {
	...
	type TestMultiOmit struct {
		Id      int64  `orm:"int(11) pk"`
		Name    string `orm:"varchar(255)"`
		Omitted string `orm:"varchar(255) 'omitted'"`
	}
...
func TestInsertTwice(t *testing.T) {
	...
	assert.EqualValues(t, orm.ErrNoElementsOnSlice, err)
...
func TestInsertDeleted(t *testing.T) {
	...
	type InsertDeletedStructNotRight struct {
		ID        uint64    `orm:"'ID' pk autoincr"`
		DeletedAt time.Time `orm:"'DELETED_AT' deleted notnull"`
	}
	...
	type InsertDeletedStruct struct {
		ID        uint64    `orm:"'ID' pk autoincr"`
		DeletedAt time.Time `orm:"'DELETED_AT' deleted"`
	}
