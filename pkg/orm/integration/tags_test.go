...
type tempUser2 struct {
	TempUser   tempUser `orm:"extends"`
	Departname string
}
type tempUser3 struct {
	Temp       *tempUser `orm:"extends"`
	Departname string
}
type tempUser4 struct {
	TempUser2 tempUser2 `orm:"extends"`
}
...
type UserAndDetail struct {
	Userinfo   `orm:"extends"`
	Userdetail `orm:"extends"`
}
...
type MessageBase struct {
	Id     int64 `orm:"int(11) pk autoincr"`
	TypeId int64 `orm:"int(11) notnull"`
}
type Message struct {
	MessageBase `orm:"extends"`
	Title       string    `orm:"varchar(100) notnull"`
	Content     string    `orm:"text notnull"`
	Uid         int64     `orm:"int(11) notnull"`
	ToUid       int64     `orm:"int(11) notnull"`
	CreateTime  time.Time `orm:"datetime notnull created"`
}
...
type MessageExtend3 struct {
	Message  `orm:"extends"`
	Sender   MessageUser `orm:"extends"`
	Receiver MessageUser `orm:"extends"`
	Type     MessageType `orm:"extends"`
}
type MessageExtend4 struct {
	Message     `orm:"extends"`
	MessageUser `orm:"extends"`
	MessageType `orm:"extends"`
}
...
type Size struct {
	ID     int64   `orm:"int(4) 'id' pk autoincr"`
	Width  float32 `json:"width" orm:"float 'Width'"`
	Height float32 `json:"height" orm:"float 'Height'"`
}
type Book struct {
	ID         int64 `orm:"int(4) 'id' pk autoincr"`
	SizeOpen   *Size `orm:"extends('Open')"`
	SizeClosed *Size `orm:"extends('Closed')"`
	Size       *Size `orm:"extends('')"`
}
...
func TestCreatedUpdated(t *testing.T) {
	...
	type CreatedUpdated struct {
		Id       int64
		Name     string
		Value    float64   `orm:"numeric"`
		Created  time.Time `orm:"created"`
		Created2 time.Time `orm:"created"`
		Updated  time.Time `orm:"updated"`
	}
...
func TestTagDefault2(t *testing.T) {
	...
	type DefaultStruct2 struct {
		Id          int64
		Name        string
		NullDefault string `orm:"default('NULL')"`
	}
...
func TestTagDefault3(t *testing.T) {
	...
	type DefaultStruct3 struct {
		Id   int64
		Name string `orm:"default('myname')"`
	}
...
func TestTagDefault5(t *testing.T) {
	...
	type DefaultStruct5 struct {
		Id      int64
		Created time.Time `orm:"default('2006-01-02 15:04:05')"`
	}
...
func TestTagTime(t *testing.T) {
	...
	type TagUTCStruct struct {
		Id      int64
		Name    string
		Created time.Time `orm:"created utc"`
	}
...
func TestIndexes(t *testing.T) {
	...
	type TestIndexesStruct struct {
		Id    int64
		Name  string `orm:"index unique(s)"`
		Email string `orm:"index unique(s)"`
	}
