...
func Open(driverName, dataSourceName string) (*DB, error) {
	...
	return &DB{
		DB:           db,
		Mapper:       name.NewCacheMapper(&name.SnakeMapper{}),
...
func (db *DB) QueryContext(ctx context.Context, query string, args ...interface{}) (*Rows, error) {
	hookCtx := ctxsvr.NewContextHook(ctx, query, args)
...
func (db *DB) beforeProcess(c *ctxsvr.ContextHook) (context.Context, error) {
...
func (db *DB) afterProcess(c *ctxsvr.ContextHook) error {
...
// AddHook adds hook
func (db *DB) AddHook(h ...ctxsvr.Hook) {
	db.hooks.AddHook(h...)
}
